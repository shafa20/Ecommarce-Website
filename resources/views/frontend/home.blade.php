        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="deal" style="background-image: url('{{ asset('frontend')}}/imgs/banner/popup-1.png')">
                        <div class="deal-top">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li>
                                            <a href="#"><img src="{{ asset('frontend')}}/imgs/theme/flag-fr.png" alt="">Français</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('frontend')}}/imgs/theme/flag-dt.png" alt="">Deutsch</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('frontend')}}/imgs/theme/flag-ru.png" alt="">Pусский</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li>
                                            <a href="#"><img src="{{ asset('frontend')}}/imgs/theme/flag-fr.png" alt="">INR</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('frontend')}}/imgs/theme/flag-dt.png" alt="">MBP</a>
                                        </li>
                                        <li>
                                            <a href="#"><img src="{{ asset('frontend')}}/imgs/theme/flag-ru.png" alt="">EU</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <div class="header-action-right">
                            <div class="header-action-2">
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        ...
                                        <div class="shopping-cart-footer">
                                            ...
                                            <div class="shopping-cart-button">
                                                ...
                                                <a href="{{ Route('checkout2')}}">Checkout</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="header-action-icon-2">
                                    ...
                                    <a href="page-account.html"><span class="lable ml-0">My Account</span></a>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                             ...
                                             <li>
                                                <a href="{{ route('register') }}"><i class="fi fi-rs-user mr-10"></i>Registration</a>
                                            </li>

                                            @if(Auth::check())

                                            <li>
                                                <a href="{{ Route('userprofile')}}"><i class="fi fi-rs-user mr-10"></i>My Account</a>
                                            </li>
                                            <li>
                ...
                <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="header-nav d-none d-lg-flex">
                            ...
                            <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        ...
                                        @if($count< 5)
                                        <li>
                                            <a href="{{ Route('cat',$cat->id) }}"> <img src="{{ asset('frontend')}}/imgs/theme/icons/category-1.svg" alt="">{{ $cat->name }}</a>
                                        </li>
                                        @elseif($count==5)
                                        </ul> <ul class="end">
                                        <li>
                                ...
                                <div class="more_slide_open" style="display: none">
                                    <div class="d-flex categori-dropdown-inner">
                                        <ul>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="{{ asset('frontend')}}/imgs/theme/icons/icon-1.svg" alt="">Milks and Dairies</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="{{ asset('frontend')}}/imgs/theme/icons/icon-2.svg" alt="">Clothing & beauty</a>
                                            </li>
                                        </ul>
                                        <ul class="end">
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="{{ asset('frontend')}}/imgs/theme/icons/icon-3.svg" alt="">Wines & Drinks</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="{{ asset('frontend')}}/imgs/theme/icons/icon-4.svg" alt="">Fresh Seafood</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    <li class="hot-deals"><img src="{{ asset('frontend')}}/imgs/theme/icons/icon-hot.svg" alt="hot deals"><a href="shop-grid-right.html">Deals</a></li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                           ...
                                           <li>
                                               <a href="shop-grid-right.html">{{ $allcat->name}}</a>
                                           <ul class="level-menu">
                                                     
                                                 @php
                                                  $allsubcats=Subcategory::where('catId', $allcat->id)->get();
                                                 @endphp
                                                 @foreach($allsubcats as $allsubcat)
                                                 <li>
                                                     <a href="shop-product-vendor.html">{{ $allsubcat->subCatName}}</a>
                                                 @endforeach
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="shop-product-right.html"><img src="{{ asset('frontend')}}/imgs/banner/banner-menu.png" alt="Nest"></a>
                    ...
                    <div class="carausel-10-columns" id="carausel-10-columns">
                        ...
                        <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            <figure class="img-hover-scale overflow-hidden">
                                <a href="shop-grid-right.html"><img src="{{ asset('backend/subcategoryimages/'.$allsubcat->image)}}" alt=""></a>
                            </figure>
                            <h6><a href="shop-grid-right.html">{{ $allsubcat->subCatName}}</a></h6>
                            <span>
                                @php
                                $allproducts=Items::where('item_code', $allsubcat->id)->get();
                               @endphp
                                ...
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-card-bottom">
                                            ...
                                            <div class="add-cart">
                                                <a class="add addcart{{ $item->id}}" href="shop-cart.html"><i class="fi-rs-shopping-cart mr-5"></i>Add </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="shop-product-right.html">
                                                <img class="default-img" src="{{ asset('frontend')}}/imgs/shop/product-16-1.jpg" alt="">
                                                <img class="hover-img" src="{{ asset('frontend')}}/imgs/shop/product-16-2.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i class="fi-rs-heart"></i></a>
                        ...
                        <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            <div class="product-img-action-wrap">
                                <div class="product-img">
                                    <a href="shop-product-right.html">
                                        <img src="{{ asset('frontend')}}/imgs/banner/banner-5.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="product-content-wrap">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                            <div class="product-img-action-wrap">
                                <div class="product-img">
                                    <a href="shop-product-right.html">
                                        <img src="{{ asset('frontend')}}/imgs/banner/banner-6.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="product-content-wrap">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 d-none d-lg-block">
                        <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                            <div class="product-img-action-wrap">
                                <div class="product-img">
                                    <a href="shop-product-right.html">
                                        <img src="{{ asset('frontend')}}/imgs/banner/banner-7.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="product-content-wrap">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 d-none d-xl-block">
                        <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                            <div class="product-img-action-wrap">
                                <div class="product-img">
                                    <a href="shop-product-right.html">
                                        <img src="{{ asset('frontend')}}/imgs/banner/banner-8.png" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="product-content-wrap">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-xl-block wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        ...
                        <div class="product-list-small animated animated">
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{ asset('frontend')}}/imgs/shop/thumbnail-10.jpg" alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{ asset('frontend')}}/imgs/shop/thumbnail-11.jpg" alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                            ...
                            <article class="row align-items-center hover-up">
                                <figure class="col-md-4 mb-0">
                                    <a href="shop-product-right.html"><img src="{{ asset('frontend')}}/imgs/shop/thumbnail-12.jpg" alt=""></a>
                                </figure>
                                <div class="col-md-8 mb-0">
                                    <h6>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="position-relative newsletter-inner">
                            ...
                            <img src="{{ asset('frontend')}}/imgs/banner/banner-9.png" alt="newsletter">
                        </div>
                    </div>
                </div>
            </div>
